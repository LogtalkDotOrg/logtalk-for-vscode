...
On Windows systems, when the user name contains spaces, the file paths on the "Problems" pane are truncated and thus non-operational. This seems to be caused by a VSCode bug.
