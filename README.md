...
This extension can be installed via extensions viewlet of VS Code or 'Extensions: install extension' command from the command palette.

Developed and tested in **_Logtalk 3.67.0_** and **_VS Code 1.80.1_** on **_macOS 13.4_** with **Node 16** . Not yet tested under other environments.
