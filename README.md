...
Click in the middle of a predicate name in a message goal or a predicate `uses/2` directive and select the "Go to References" or "Find All References" menu or context menu items. References is interpreted here as messages.
