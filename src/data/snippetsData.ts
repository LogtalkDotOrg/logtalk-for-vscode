...
/**
 * Snippet data structure - the single source of truth for all Logtalk snippets.
 * Used by both the CompletionItemProvider (for code completions) and 
 * the HoverProvider (for hover documentation via Utils.getSnippetDescription).
 */
...
/**
 * Dictionary of snippets keyed by their identifier.
 * This is the canonical source of snippet data for the extension.
 */
export interface ISnippetDictionary {
  [key: string]: ISnippet;
}

/**
 * All Logtalk snippets data.
 * This constant serves as the single source of truth for snippets,
 * replacing the previous snippets/logtalk.json file.
 */
export const LOGTALK_SNIPPETS: ISnippetDictionary = {
